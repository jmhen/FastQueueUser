 ...
 */
public class OrderHistoryListCustomAdapter extends RecyclerView.Adapter<OrderHistoryListCustomAdapter.ViewHolder> {
        ...
        public ViewHolder(View v) {
            ...
            food_name.setOnClickListener(new View.OnClickListener() {
                 ...
                 public void onClick(View v) {
                     Log.d(TAG, "History item  " + getAdapterPosition() + " clicked.");
                 }
            });
//            foodCheck = (CheckBox) v.findViewById(R.id.foodCheckBox);
     ...
     */
    public OrderHistoryListCustomAdapter(ArrayList<CollectItem> dataSet) {
        mDataSet = dataSet;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.items_view3, viewGroup, false);
